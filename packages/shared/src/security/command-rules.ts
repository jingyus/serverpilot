...
/**
 * Command classification rule definitions — single source of truth.
 * Contains pattern rules for five-level command risk classification.
 *
 * Used by both Agent and Server to ensure consistent security enforcement.
 * This module has NO external dependencies (no Zod, no Node APIs).
 *
