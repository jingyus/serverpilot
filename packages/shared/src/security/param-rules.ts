...
/**
 * Parameter auditor — dangerous parameter blacklist and protected path detection.
 *
 ...
 *
 * This module has NO external dependencies beyond Zod (for schemas only).
 *
 * @module security/param-rules
 */
