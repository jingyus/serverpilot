...
export function generateOpenAPIDocument(): object {
  ...
  _cachedDocument = generator.generateDocument({
    ...
    tags: [
      { name: 'Auth', description: 'User authentication, token management, and GitHub OAuth' },
      ...
      { name: 'Chat', description: 'AI chat, plan execution and cancellation (SSE streaming)' },
      ...
      { name: 'Operations', description: 'Operation history and statistics' },
      { name: 'Agent', description: 'Agent version checking and binary downloads' },
      { name: 'Knowledge', description: 'Documentation scraping and knowledge base search' },
      { name: 'Doc Sources', description: 'Documentation source management' },
      { name: 'Settings', description: 'User settings, AI provider config, and health check' },
      { name: 'Metrics', description: 'Server monitoring metrics and real-time SSE stream' },
      { name: 'Audit Log', description: 'Security audit trail querying and CSV export' },
      { name: 'Webhooks', description: 'Webhook endpoint management, testing, and delivery history' },
      { name: 'Members', description: 'Tenant member role management (legacy)' },
      { name: 'Team', description: 'Team invitations, member management, and public invite acceptance' },
