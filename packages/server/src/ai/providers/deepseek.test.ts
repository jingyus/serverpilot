...
import { DeepSeekProvider, DeepSeekError, DeepSeekConfigSchema } from './deepseek.js';
...
describe('DeepSeekProvider', () => {
  ...
  describe('DeepSeekError', () => {
    ...
    it('should have correct name for authentication error', () => {
      const err = new DeepSeekError('DeepSeek authentication failed: Invalid API key', 401);
      expect(err.name).toBe('DeepSeekError');
