...
### [completed] sessionLocks 超时后残留 — 30s 超时不清理 Map 条目导致后续请求永远等待 ✅
...
### [completed] 删除会话未检查活跃执行 — 用户删除正在执行的会话导致悬挂资源 ✅
...
### [completed] cancelStream 未重置执行相关状态 — 取消流式后 UI 可能显示旧的执行进度 ✅
...
### [completed] Agentic 循环 MAX_TURNS=25 时无用户感知 — AI 静默停止不解释原因 ✅
...
**影响范围**: `packages/server/src/ai/agentic-chat.ts`
**创建时间**: 2026-02-13
**完成时间**: 2026-02-13 14:41:43

---

### [completed] 前端 Agentic 模式无工具调用摘要 — 用户看不到 AI 执行了哪些命令及结果 ✅
...
**创建时间**: 2026-02-13
**完成时间**: 2026-02-13 14:47:15

---

### [completed] MessageInput 输入框每次按键触发 layout thrash — 长文本输入时可能卡顿 ✅
...
### [completed] Agentic 模式 serverProfile 类型为 unknown — 3 处 `as` 断言无运行时验证 ✅
...
**创建时间**: 2026-02-13
**完成时间**: 2026-02-13 14:58:58

---

### [completed] apiRequest 无请求超时 — 挂起的网络请求永远阻塞 UI ✅
...
**创建时间**: 2026-02-13
**完成时间**: 2026-02-13 15:05:31

---

### [completed] Agentic 循环错误信息不区分类型 — 用户看到泛化的"执行过程中发生错误" ✅
...
**影响范围**: `packages/server/src/ai/agentic-chat.ts`
**创建时间**: 2026-02-13
**完成时间**: 2026-02-13 15:11:08

---

### [completed] ExecutionSummary duration 是静态快照 — 不显示实时计时器 ✅
...
**影响范围**: `packages/dashboard/src/components/chat/ExecutionLog.tsx`
**创建时间**: 2026-02-13
**完成时间**: 2026-02-13 15:14:25

---

### [completed] 并发 401 响应触发多次 auth:logout 事件 — 可能导致多次路由跳转 ✅
...
### [completed] 后端 session API 无重命名端点 — 缺少 PATCH /sessions/:id 支持前端会话重命名 ✅
...
### [completed] chat-execution.ts 超过 500 行软限制（652 行）— SSE 回调构建器可提取 ✅
